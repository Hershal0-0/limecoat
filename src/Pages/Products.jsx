...
const Products = () => {
  return (
    <div>
      <div className="mt-10 ">
        <div className="relative flex flex-col items-center justify-center group text-[2.5rem] font-[200] ">
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-5 max-w-fit ">
            {productInfo.map((product, index) => {
              return (
                <div
                  key={index}
                  className="flex flex-col mb-5 md:flex-row h-50 group borderBlack1"
                >
                  <div className="relative flex-1  w-[20rem] sm:w-[30rem] borderBlack1 ">
                    <img
                      src={product.img}
                      alt=""
                      className="mx-auto h-[40rem] borderBlack1"
                    />
                    <div className="absolute w-full h-40 text-white/70 transition-transform duration-500 origin-bottom transform scale-y-0 bg-black/20 text-[2rem] bottom-10 group-hover:scale-y-100">
                      {product.desc}
                    </div>
                    <div className="flex items-center justify-center h-10 bg-blue-200">
                      {product.name}
                    </div>
                  </div>
                </div>
